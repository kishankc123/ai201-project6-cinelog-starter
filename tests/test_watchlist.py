...
def test_add_to_watchlist_creates_private_entry(app, sample_user, sample_film):
    """
    Adding a valid film should create a private WatchlistEntry by default.
    """
    with app.app_context():
...
def test_add_to_watchlist_can_create_public_entry(app, sample_user, sample_film):
    """
    Callers can explicitly mark a watchlist entry public.
    """
    with app.app_context():
